...
class CreateKmrplmabdimaseksternalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kmrplmabdimaseksternal', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('kmrplmabdimaseksternal');
    }
}
