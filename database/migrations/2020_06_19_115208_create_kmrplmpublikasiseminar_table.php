...
class CreateKmrplmpublikasiseminarTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kmrplmpublikasiseminar', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('kmrplmpublikasiseminar');
    }
}
