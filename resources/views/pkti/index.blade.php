				...
				<div class="col-md-12">
					<div class="panel">
								<div class="panel-heading">
									...
									<h3 class="panel-title">Program Kerja KK Teknologi Informasi</h3>
									<div class="right">
									<!-- <a href="/pkti/export" class="btn sm btn-primary">EXPORT EXCEL</a>
									<a href="/pkti/exportPdf" class="btn btn-primary">CETAK PDF</a> -->
										...
										<thead>
                                         ...
                                         <tbody>
                                         	...
                                         	<tr>
                                         		...
                                         		<td>{{$pkti->status}}</td>
                                         		<td>
                                         			<a href="/pkti/{{$pkti->id}}/edit" class="btn btn-warning btn-sm">Edit</a>
                                         			<a href="/pkti/{{$pkti->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Ingin Menghapus?')">Delete</a>
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			      	<form action="/pkti/create" method = "POST">
			      		{{csrf_field()}}
			        <form>
