				...
				<div class="col-md-12">
					<div class="panel">
								<div class="panel-heading">
									...
									<h3 class="panel-title">Profil KK Rekayasa Data</h3>
									<div class="right">
								...
								<div class="panel-body">
									<table class="table table-hover" id="datatable">
										<thead>
                                         ...
                                         <tbody>
                                         	@foreach($data_rd as $rd)
                                         	<tr>
                                         		<td>{{$rd->namadosen}}</td>
                                         		<td>{{$rd->nidn}}</td>
                                         		<td>{{$rd->prodi}}</td>
                                         		@php
                                         		$coba=explode(',',$rd->id_topic)
                                         		@endphp
                                         			<td>
                                         		 <ul>
                                         		...
                                         		@role('rd')
                                         		<td>
                                         			<a href="/rd/{{$rd->id}}/edit" class="btn btn-warning btn-sm">Edit</a>
                                         			<a href="/rd/{{$rd->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Ingin Menghapus?')">Delete</a>
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			      	<form action="{{route('createRd')}}" method = "POST">
			      		{{csrf_field()}}
			        <form>
