									...
									<button type="button"  data-toggle="modal" data-target="#exampleModal" style="background-color:#e4cb10; color: white;padding: 6px 22px; box-shadow: 0px 1px 2px 0 rgba(0, 0, 0, 0.2);">Create</button>
									 <div class="dropdown show">
											  ...
											  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
											  	<ul>
											  		<li><a href="/kmtkse/kmtksere/export">EXPORT SEMUA</a></li>
											  		<li><a class="dropdown-item" href="/kmtkse/kmtksere/export/TW1">TW 1</a></li>
											  		<li><a class="dropdown-item" href="/kmtkse/kmtksere/export/TW2">TW 2</a></li>
											  		<li><a class="dropdown-item" href="/kmtkse/kmtksere/export/TW3">TW 3</a></li>
											  		<li><a class="dropdown-item" href="/kmtkse/kmtksere/export/TW4">TW 4</a></li>
								...
								<div class="panel-body">
									...
									<table class="table table-hover" id="datatable">
										<thead>
                                         ...
                                         @foreach($data_kmtksere as $kmtksere)
                                         	<tr>
                                         		...
                                         		@role('tkse')
                                         		<td>
                                         			<a href="/kmtkse/kmtksere/{{$kmtksere->id}}/editre" class="btn btn-warning btn-sm">Edit</a>
                                         			<a href="/kmtkse/kmtksere/{{$kmtksere->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Ingin Menghapus?')">Delete</a>
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h5 class=" modal-title" id="exampleModalLabel">Masukan Kontrak Manajemen kmtksere</h5>
			        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			          <span aria-hidden="true">&times;</span>
			        </button>
			      </div>
			      <div class="modal-body">
			      	<form action="/kmtkse/kmtksere/create" method = "POST">
			      		{{csrf_field()}}
			         <form>
