				...
				<div class="col-md-12">
					<div class="panel">
								<div class="panel-heading">
									...
									<h3 class="panel-title">Kontrak Manajemen HaKi KK Tata Kelola dan Sistem Enterprise</h3>
									<div class="">
									 ...
									 <div class="dropdown show">
											  ...
											  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
											  	<ul>
											  		<li><a href="/kmtkse/kmtksehk/export">EXPORT SEMUA</a></li>
											  		<li><a class="dropdown-item" href="/kmtkse/kmtksehk/export/TW1">TW 1</a></li>
											  		<li><a class="dropdown-item" href="/kmtkse/kmtksehk/export/TW2">TW 2</a></li>
											  		<li><a class="dropdown-item" href="/kmtkse/kmtksehk/export/TW3">TW 3</a></li>
											  		<li><a class="dropdown-item" href="/kmtkse/kmtksehk/export/TW4">TW 4</a></li>
								...
								<div class="panel-body">
									...
									<table class="table table-hover" id="datatable">
										<thead>
                                         ...
                                         @foreach($data_kmtksehk as $kmtksehk)
                                         	<tr>
                                         		<td>{{$kmtksehk->judulhaki}}</td>
                                         		<td>{{$kmtksehk->periode}}</td>
                                         		<td>{{$kmtksehk->pemeganghakcipta}}</td>
                                         		<td>{{$kmtksehk->pencipta}}</td>
                                         		<td>{{$kmtksehk->pencipta2}}</td>
                                         		<td>{{$kmtksehk->pencipta3}}</td>
                                         		<td>{{$kmtksehk->pencipta4}}</td>
                                         		<td>{{$kmtksehk->pencipta5}}</td>
                                         		<td>{{$kmtksehk->pencipta6}}</td>
                                         		<td>{{$kmtksehk->pencipta7}}</td>
                                         		<!-- <td>{{$kmtksehk->kelompokkeahlian}}</td> -->
                                         		<td>{{$kmtksehk->jenisciptaan}}</td>
                                         		<td>{{$kmtksehk->tgl}}</td>
                                         		<td>Rp {{number_format($kmtksehk->biayapendaftaran,0,'.','.')}}</td>
                                         		<td>{{$kmtksehk->status}}</td>
                                         		@role('tkse')
                                         		<td>
                                         			<a href="/kmtkse/kmtksehk/{{$kmtksehk->id}}/edithk" class="btn btn-warning btn-sm">Edit</a>
                                         			<a href="/kmtkse/kmtksehk/{{$kmtksehk->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Ingin Menghapus?')">Delete</a>
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			      	<form action="/kmtkse/kmtksehk/create" method = "POST">
			      		{{csrf_field()}}
			      <form>
