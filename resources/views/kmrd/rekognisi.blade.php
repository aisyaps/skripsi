				...
				<div class="col-md-12">
					<div class="panel">
								<div class="panel-heading">
									...
									<h3 class="panel-title">Kontrak Manajemen Rekognisi KK Rekayasa Data</h3>
								<div class="">
									<button type="button"  data-toggle="modal" data-target="#exampleModal" style="background-color:#e4cb10; color: white;padding: 6px 22px; box-shadow: 0px 1px 2px 0 rgba(0, 0, 0, 0.2);">Create</button>
									 <div class="dropdown show">
											  ...
											  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
											  	<ul>
											  		<li><a href="/kmrd/rekognisi/export">EXPORT SEMUA</a></li>
											  		<li><a class="dropdown-item" href="/kmrd/rekognisi/export/TW1">TW 1</a></li>
											  		<li><a class="dropdown-item" href="/kmrd/rekognisi/export/TW2">TW 2</a></li>
											  		<li><a class="dropdown-item" href="/kmrd/rekognisi/export/TW3">TW 3</a></li>
											  		<li><a class="dropdown-item" href="/kmrd/rekognisi/export/TW4">TW 4</a></li>
								...
								<div class="panel-body">
									<table class="table table-hover" id="datatable">
										<thead>
                                         ...
                                         @foreach($data_rekognisi as $rekognisi)
                                         	<tr>
                                         		...
                                         		<td>
                                         			...
                                         			<a href="/kmrd/rekognisi/{{$rekognisi->id}}/editre" class="btn btn-warning btn-sm">Edit</a>
                                         			<a href="/kmrd/rekognisi/{{$rekognisi->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Ingin Menghapus?')">Delete</a>
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			      	<form action="/kmrd/rekognisi/create" method = "POST">
			      		{{csrf_field()}}
			        <form>
