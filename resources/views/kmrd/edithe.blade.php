			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="panel">
								...
								<form action="/kmrd/hibaheksternal/{{$hibaheksternal->id}}/update" method = "POST">
			      		{{csrf_field()}}
			  				  <form>
		                
						 <div class="form-group {{$errors->has('judulpenelitian') ? 'has-error' : ''}}">
						    <label for="exampleInputEmail1">Judul penelitian</label>
						    <input name="judulpenelitian" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan judul penelitian" value="{{$hibaheksternal->judulpenelitian}}">
						  ...
						  <div class="form-group {{$errors->has('peneliti1') ? 'has-error' : ''}}">
						    ...
						    <input name="peneliti1" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan peneliti1" value="{{$hibaheksternal->peneliti1}}">
						 ...
						 <div class="form-group">
						    ...
						    <input name="anggotapeneliti2" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan anggota peneliti" value="{{$hibaheksternal->anggotapeneliti2}}">
						  </div>
						  	  <div class="form-group">
						  	 <label for="exampleInputEmail1">Anggota peneliti 3</label>
						    <input name="anggotapeneliti3" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan anggota peneliti"value="{{$hibaheksternal->anggotapeneliti3}}" >
						  </div>
						  	  <div class="form-group">
						  	 <label for="exampleInputEmail1">Anggota peneliti 4</label>
						    <input name="anggotapeneliti4" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan anggota peneliti" value="{{$hibaheksternal->anggotapeneliti4}}">
						  </div>
						   <!-- <div class="form-group">
						  ...
						  <div class="form-group">
						    ...
						    <input name="dana_diajukan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan dana yang diajukan" value="{{$hibaheksternal->dana_diajukan}}">
						  </div>
						   <div class="form-group {{$errors->has('dana_disetujui') ? 'has-error' : ''}}">
						    <label for="exampleInputEmail1">Dana yang disetujui</label>
						    <input name="dana_disetujui" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan dana yang disetujui" value="{{$hibaheksternal->dana_disetujui}}" >
						  ...
						  <div class="form-group">
						    ...
						    <input name="keterangan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan keterangan" value="{{$hibaheksternal->keterangan}}">
						  </div>
						    <div class="form-group">
