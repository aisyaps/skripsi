				...
				<div class="col-md-12">
					<div class="panel">
								<div class="panel-heading">
									...
									<h3 class="panel-title">Kontrak Manajemen Rekognisi KK Rekayasa Perangkat Lunak dan Multimedia</h3>
									<div class="">
									 ...
									 <div class="dropdown show">
											  ...
											  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
											  	<ul>
											  		<li><a href="/kmrplm/kmrplmrekognisi/export">EXPORT SEMUA</a></li>
											  		<li><a class="dropdown-item" href="/kmrplm/kmrplmrekognisi/export/TW1">TW 1</a></li>
											  		<li><a class="dropdown-item" href="/kmrplm/kmrplmrekognisi/export/TW2">TW 2</a></li>
											  		<li><a class="dropdown-item" href="/kmrplm/kmrplmrekognisi/export/TW3">TW 3</a></li>
											  		<li><a class="dropdown-item" href="/kmrplm/kmrplmrekognisi/export/TW4">TW 4</a></li>
								...
								<div class="panel-body">
									...
									<table class="table table-hover" id="datatable">
										<thead>
                                         ...
                                         @foreach($data_kmrplmrekognisi as $kmrplmrekognisi)
                                         	<tr>
                                         		...
                                         		@role('rplm')
                                         		<td>
                                         			<a href="/kmrplm/kmrplmrekognisi/{{$kmrplmrekognisi->id}}/editre" class="btn btn-warning btn-sm">Edit</a>
                                         			<a href="/kmrplm/kmrplmrekognisi/{{$kmrplmrekognisi->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Ingin Menghapus?')">Delete</a>
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h5 class=" modal-title" id="exampleModalLabel">Masukan Kontrak Manajemen Rekognisi</h5>
			        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			          <span aria-hidden="true">&times;</span>
			        </button>
			      </div>
			      <div class="modal-body">
			      	<form action="/kmrplm/kmrplmrekognisi/create" method = "POST">
			      		{{csrf_field()}}
			      		<form>
