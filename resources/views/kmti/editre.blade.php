			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="panel">
								...
								<form action="/kmti/kmtire/{{$kmtire->id}}/update" method = "POST">
			      		{{csrf_field()}}
			            <form>
						 <div class="form-group {{$errors->has('judulkegiatan') ? 'has-error' : ''}}">
						    <label for="exampleInputEmail1">Judul kegiatan</label>
						    <input name="judulkegiatan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan judul kegiatan" value="{{$kmtire->judulkegiatan }}">
						  ...
						  <div class="form-group {{$errors->has('namadosen') ? 'has-error' : ''}}">
						    ...
						    <input name="namadosen" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan nama dosen" value="{{ $kmtire-> namadosen}}">
						...
						<div class="form-group {{$errors->has('tgl1') ? 'has-error' : ''}}">
						    <label for="exampleInputEmail1">Tanggal mulai</label>
						      <input name="tgl1" type="date"class="form-control" id="tgl1" value ="{{$kmtire-> tgl1}}">
						       @if($errors->has('tgl1'))
						    ...
						    <label for="exampleInputEmail1">Tanggal selesai</label>
						      <input name="tgl2" type="date"class="form-control" id="tgl2" value ="{{$kmtire-> tgl2}}">
						       @if($errors->has('tgl2'))
						   ...
						   <div class="form-group ">
						    ...
						    <input name="tempat" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan tempat"  value="{{ $kmtire->tempat }}">
						  </div>
						   <div class="form-group {{$errors->has('penyelenggara') ? 'has-error' : ''}}">
						    <label for="exampleInputEmail1">Penyelenggara</label>
						    <input name="penyelenggara" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan penyelenggara" value="{{ $kmtire-> penyelenggara }}">
						   ...
						   <div class="form-group{{$errors->has('prodidosen') ? 'has-error' : ''}}">
						    ...
						    <input name="prodidosen" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan prodi dosen" value="{{ $kmtire-> prodidosen }}">
						    ...
						    <input name="keterangan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan keterangan atau evidence" value="{{ $kmtire-> keterangan }}" >
						  </div>
