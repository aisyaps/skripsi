				...
				<div class="col-md-12">
					<div class="panel">
								<div class="panel-heading">
									...
									<h3 class="panel-title">Program Kerja KK Tata Kelola dan Sistem Enterprise</h3>
									<div class="right">
									<!-- <a href="/pktkse/export" class="btn sm btn-primary">Export Excel</a>
									<a href="/pktkse/exportPdf" class="btn sm btn-primary">Export PDF</a> -->
										...
										<thead>
                                         ...
                                         <tbody>
                                         	...
                                         	<tr>
                                         		...
                                         		<td>{{$pktkse->status}}</td>
                                         		<td>
                                         			<a href="/pktkse/{{$pktkse->id}}/edit" class="btn btn-warning btn-sm">Edit</a>
                                         			<a href="/pktkse/{{$pktkse->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Ingin Menghapus?')">Delete</a>
			  ...
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			      	<form action="/pktkse/create" method = "POST">
			      		{{csrf_field()}}
			        <form>
